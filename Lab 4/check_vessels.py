...
LINKS_PATH = '/home/lilcmetanka/Documents/Rvota/Lab 4/Links.xlsx'
RESULT_PATH = '/home/lilcmetanka/Documents/Rvota/Lab 4/result.xlsx'
    ...
    for link in links:
        try:
            ...
            if data and any(data):
                print(f'[INFO] Добавлен судно: {data}')
                results.append(data)
